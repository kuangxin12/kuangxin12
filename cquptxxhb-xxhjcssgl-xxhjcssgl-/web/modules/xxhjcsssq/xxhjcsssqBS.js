define(function(require, exports, module) {
	...
	var bs = {
		api: {
			pageModel: 'modules/xxhjcsssq.do',
...
//			return BH_UTILS.doAjax('../modules/xxhjcsssq/T_PXXX_XSJBXX_SAVE.do', formData);
		},
		del: function(params){
			//TODO 添加删除动作
			return BH_UTILS.doAjax('../modules/xxhjcsssq/T_XXB_XXHJCSS_JBXX_DELETE.do', {
				T_XXB_XXHJCSS_JBXX_DELETE:JSON.stringify(params)
			});
		},
