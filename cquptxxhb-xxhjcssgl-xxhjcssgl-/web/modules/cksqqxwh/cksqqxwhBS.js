define(function(require, exports, module) {
	...
	var bs = {
		...
		save: function(formData){
			...
			return BH_UTILS.doAjax('../modules/cksqqxwh/T_XXB_XXHJCSS_CKQX_SAVE.do', formData);
		},
		del: function(params){
			//TODO 添加删除动作
			return BH_UTILS.doAjax('../modules/cksqqxwh/T_XXB_XXHJCSS_CKQX_DELETE.do', {
				T_XXB_XXHJCSS_CKQX_DELETE:JSON.stringify(params)
			});
		},
