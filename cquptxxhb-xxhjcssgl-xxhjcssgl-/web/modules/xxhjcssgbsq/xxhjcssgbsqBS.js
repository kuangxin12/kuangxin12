define(function(require, exports, module) {
	...
	var bs = {
		api: {
			pageModel: 'modules/xxhjcssgbsq.do',
		...
		save: function(formData){
			...
			return BH_UTILS.doAjax('../modules/xxhjcssgbsq/T_XXB_XXHJCSS_GB_SAVE.do', formData);
		},
		del: function(params){
			//TODO 添加删除动作
			return BH_UTILS.doAjax('../modules/xxhjcssgbsq/T_XXB_XXHJCSS_GB_DELETE.do', {
				T_XXB_XXHJCSS_GB_DELETE:JSON.stringify(params)
			});
		},
