define(function(require, exports, module) {
    ...
    var viewConfig = {
        initialize: function(id,taskid,lx,cksq) {
         ...
         /*   var diz =  WIS_EMAP_SERV.getContextPath()+'/sys/emapflow/tasks/queryFlowState.do?taskId='+taskid+'&defKey=xxhjcssgl.whsqq'
            document.getElementById('flow').src = diz;*/
            
//            $("#lczt").click(function(){             	 
//               	window.open(WIS_EMAP_SERV.getContextPath()+'/sys/emapflow/tasks/queryFlowState.do?taskId='+taskid+'&defKey=xxhjcssgl.whsqq')
//                	});
            
         //   $("#emapForm").emapForm("setValue", data);
           // _emapShowItem.showItemByLx(lx);
