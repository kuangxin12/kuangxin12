    		...
    		initialize: function(id,taskid,lx,cksq) {
                ...
                if (lx == "虚拟机"){
                	...
                	if (cksq == '否' || cksq == '0'){
            			...
            			.parent().parent().css("display", "none");
                	$("#emapForm [data-name=TGFWQ_CPUHX]").parent().parent()
    	    			.css("display", "none");
             		 $("#emapForm [data-name=TGFWQ_CPUZP]").parent().parent()
    	    			.css("display", "none");
             		 $("#emapForm [data-name=TGFWQ_CPUSL]").parent().parent()
     	    			.css("display", "none");
                	}           	
                } else if (lx == "托管服务器") {
                	$("#emapForm [data-name=XNJ_CZXT]").parent().parent().parent().parent().css("display", "none");
                	if (cksq == '否' || cksq == '0'){
                	$("#emapForm [data-name=CK_IP]").parent().parent()
        			.parent().parent().css("display", "none");                 
                	}
                	 $("#emapForm [data-name=XNJ_CPU]").parent().parent()
 	    			.css("display", "none");
             	 $("#emapForm [data-name=XNJ_CZXT]").parent().parent()
 	    			.css("display", "none");
                }
