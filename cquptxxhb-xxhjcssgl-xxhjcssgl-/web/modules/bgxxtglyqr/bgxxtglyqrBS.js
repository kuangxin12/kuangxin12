define(function(require, exports, module) {
	...
	var bs = {
		api: {
			pageModel: 'modules/bgxxtglyqr.do',
		...
		save: function(formData){
			...
			return BH_UTILS.doAjax('../modules/bgxxtglyqr/T_XXB_XXHJCSS_ZRRBGJL_SAVE.do', formData);
		},
		del: function(params){
			//TODO 添加删除动作
//			return BH_UTILS.doAjax('../modules/bgxxtglyqr/T_PXXX_XSJBXX_DELETE.do', {
