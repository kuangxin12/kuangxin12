define(function(require, exports, module) {
  ...
  var bmldgbshSave = require('./bmldgbshSave');
  var bmldgbshView = require('./bmldgbshView');
 ...
 // var taskType = "ALL_TASK"; //任务类型
  ...
  var viewConfig = {
    initialize: function() {
      var view = utils.loadCompiledPage('bmldgbsh');
      this.$rootElement.html(view.render({}), true);
      this.pushSubView([bmldgbshSave]);
      this.initView();
...
//      setTimeout(actionGetShData,20000);
    ...
    actionAudit:function(e){
    	...
    	var bmldgbshEditTpl = utils.loadCompiledPage('bmldgbshSave');
        ...
        $.bhPaperPileDialog.show({
          content: bmldgbshEditTpl.render({}),
          title: "审核",
          ready: function($header, $body, $footer){
        	  bmldgbshSave.initialize(data,id,taskid,lx,cksq);       
    ...
    actionDetail: function(e){
      var id = $(e.target).attr("data-x-wid");
      var lcxx=_util.getpromid(id,'bmldgbsh','T_XXB_XXHJCSS_GB_QUERY');
      if(lcxx=='error'){
  		$.bhTip({
				content : '获取流程id失败',
				state : 'danger',
      ...
      var bmldgbshViewTpl = utils.loadCompiledPage('bmldgbshSave');
      var data = WIS_EMAP_SERV.getData(bs.api.pageModel, 'gbssjbxx', {WID_1:id,pageNumber:1});
      ...
      $.bhPaperPileDialog.show({
        content: bmldgbshViewTpl.render({}),
        title: "详情",
        ready: function($header, $body, $footer){
          bmldgbshView.initialize(id,taskid,lx,cksq);
          $("#emapForm").emapForm("setValue", data.rows[0]);
        }
      });
    },
...
//					  _sjtj.fzrgbshtj();
    ...
    //流程状态事件
		actionLczt:function(e){
	  		var id = $(e.target).attr("data-x-wid");
	    	var pid=_util.getpromid(id,'bmldgbsh','T_XXB_XXHJCSS_GB_QUERY');
	    ...
	    _initTable: function() {
	    	...
	    	var params = {
	            	  ...
	            	  nodeId : 'bmldshgb', // 流程定义中人工环节的编号，必填
	            	  appName : 'xxhjcssgl',// 应用的名称，必填
	            	  module : 'modules', // 模块名，可以没有，默认modules
	            	  page : 'bmldgbsh', // 回调动作的epg的编号，必填
	            ...
	            cellsRenderer: function(row, column, value, rowData) {
	            	...
	            	if (rowData.PROCESSINSTANCEID != null ){  //流程信息是否为空
						...
						str += ' <a href="javascript:void(0)" data-action="audit" data-x-wid='+ rowData.WID
			        	 ...
			        	 if(zzhj == 'bmldshgb' && rowData.FLOWSTATUS == "5"){
